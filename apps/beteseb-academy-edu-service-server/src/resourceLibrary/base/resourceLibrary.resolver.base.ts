...
import { CreateResourceLibraryArgs } from "./CreateResourceLibraryArgs";
import { UpdateResourceLibraryArgs } from "./UpdateResourceLibraryArgs";
...
export class ResourceLibraryResolverBase {
  ...
  async createResourceLibrary(
    @graphql.Args() args: CreateResourceLibraryArgs
  ): Promise<ResourceLibrary> {
  ...
  async updateResourceLibrary(
    @graphql.Args() args: UpdateResourceLibraryArgs
  ): Promise<ResourceLibrary | null> {
    try {
