...
@InputType()
class PerformanceAnalyticsCreateNestedManyWithoutStudentsInput {
...
export { PerformanceAnalyticsCreateNestedManyWithoutStudentsInput as PerformanceAnalyticsCreateNestedManyWithoutStudentsInput };
